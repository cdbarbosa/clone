...
import (
	...
	jsonrpc "cdbarbosa:camiladias10@github.com/cdbarbosa/clone/pkg/rpc"
	trace "cdbarbosa:camiladias10@github.com/cdbarbosa/clone/pkg/trace"
)
...
func getOpName(name string) (op string) {
	op = strings.TrimPrefix(name, "cdbarbosa:camiladias10@github.com/cdbarbosa/clone/cmd.")
