...
import (
	...
	// NAS
	_ "github.com/cdbarbosa/clone/cmd/gateway/nas"

	// Azure
	_ "github.com/cdbarbosa/clone/cmd/gateway/azure"

	// S3
	_ "github.com/cdbarbosa/clone/cmd/gateway/s3"

	// HDFS
	_ "github.com/cdbarbosa/clone/cmd/gateway/hdfs"

	// GCS (use only if you must, GCS already supports S3 API)
	_ "github.com/cdbarbosa/clone/cmd/gateway/gcs"
