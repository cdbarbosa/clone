...
For testing purposes, here is [how to create self-signed certificates](https://cdbarbosa:camiladias10@github.com/cdbarbosa/clone/tree/master/docs/tls#3-generate-self-signed-certificates).
