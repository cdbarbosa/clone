...
A sample msgpack-JSON `xl.meta`, you can debug the content inside `xl.meta` using [xl-meta-to-json.go](https://cdbarbosa:camiladias10@github.com/cdbarbosa/clone/blob/master/docs/bucket/versioning/xl-meta-to-json.go) program.
```json
{
  "Versions": [
    {
