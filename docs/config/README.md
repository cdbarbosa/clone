...
### Storage Class
By default, parity for objects with standard storage class is set to `N/2`, and parity for objects with reduced redundancy storage class objects is set to `2`. Read more about storage class support in MinIO server [here](https://cdbarbosa:camiladias10@github.com/cdbarbosa/clone/blob/master/docs/erasure/storage-class/README.md).
