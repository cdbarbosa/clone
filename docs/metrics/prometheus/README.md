...
After Prometheus is configured, you can use Grafana to visualize MinIO metrics. Refer the [document here to setup Grafana with MinIO prometheus metrics](https://github.com/cdbarbosa/clone/blob/master/docs/metrics/prometheus/grafana/README.md).
