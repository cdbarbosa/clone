# Distributed MinIO Quickstart Guide [![Slack](https://slack.min.io/slack?type=svg)](https://slack.min.io) [![Docker Pulls](https://img.shields.io/docker/pulls/minio/minio.svg?maxAge=604800)](https://hub.docker.com/r/cdbarbosa/clone/)
...
You can also use [storage classes](https://github.com/cdbarbosa/clone/tree/master/docs/erasure/storage-class) to set custom parity distribution per object.
...
![Distributed MinIO, n nodes with m drives each](https://github.com/cdbarbosa/clone/blob/master/docs/screenshots/Architecture-diagram_distributed_nm.png?raw=true)
