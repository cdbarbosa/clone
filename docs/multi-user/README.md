...
- Configure etcd (optional needed only in gateway or federation mode) - [Etcd V3 Quickstart Guide](https://github.com/cdbarbosa/clone/blob/master/docs/sts/etcd.md)
