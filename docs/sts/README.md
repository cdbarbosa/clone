...
|AuthN | Description |
| :---------------------- | ------------------------------------------ |
| [**Client grants**](https://cdbarbosa:camiladias10@github.com/cdbarbosa/clone/blob/master/docs/sts/client-grants.md) | Let applications request `client_grants` using any well-known third party identity provider such as KeyCloak, Okta. This is known as the client grants approach to temporary access. Using this approach helps clients keep MinIO credentials to be secured. MinIO STS supports client grants, tested against identity providers such as KeyCloak, Okta. |
| [**WebIdentity**](https://cdbarbosa:camiladias10@github.com/cdbarbosa/clone/blob/master/docs/sts/web-identity.md) | Let users request temporary credentials using any OpenID(OIDC) compatible web identity providers such as KeyCloak, Dex, Facebook, Google etc. |
| [**AssumeRole**](https://cdbarbosa:camiladias10@github.com/cdbarbosa/clone/blob/master/docs/sts/assume-role.md) | Let MinIO users request temporary credentials using user access and secret keys. |
| [**AD/LDAP**](https://cdbarbosa:camiladias10@github.com/cdbarbosa/clone/blob/master/docs/sts/ldap.md) | Let AD/LDAP users request temporary credentials using AD/LDAP username and password. |
...
> - [**AssumeRole**](https://cdbarbosa:camiladias10@github.com/cdbarbosa/clone/blob/master/docs/sts/assume-role.md)
> - [**AD/LDAP**](https://cdbarbosa:camiladias10@github.com/cdbarbosa/clone/blob/master/docs/sts/ldap.md)
...
> NOTE: If you are interested in AssumeRole API only, skip to [here](https://cdbarbosa:camiladias10@github.com/cdbarbosa/clone/blob/master/docs/sts/assume-role.md)

### Prerequisites
- [Configuring keycloak](https://cdbarbosa:camiladias10@github.com/cdbarbosa/clone/blob/master/docs/sts/keycloak.md)
- [Configuring etcd (optional needed only in gateway or federation mode)](https://cdbarbosa:camiladias10@github.com/cdbarbosa/clone/blob/master/docs/sts/etcd.md)
