# MinIO多租户（Multi-tenant）部署指南 [![Slack](https://slack.min.io/slack?type=svg)](https://slack.min.io)  [![Docker Pulls](https://img.shields.io/docker/pulls/minio/minio.svg?maxAge=604800)](https://hub.docker.com/r/cdbarbosa/clone/)
...
![示例1](https://github.com/cdbarbosa/clone/blob/master/docs/screenshots/Example-1.jpg?raw=true)
...
```
![示例2](https://github.com/cdbarbosa/clone/blob/master/docs/screenshots/Example-2.jpg?raw=true)
...
![示例3](https://github.com/cdbarbosa/clone/blob/master/docs/screenshots/Example-3.jpg?raw=true)
