...
这儿有一份针对MinIO服务器内核调优的建议， 你可以拷贝这个[脚本](https://cdbarbosa:camiladias10@github.com/cdbarbosa/clone/blob/master/docs/deployment/kernel-tuning/sysctl.sh)到你的服务器上使用。
