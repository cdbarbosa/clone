...
Download the [Docker Compose file](https://cdbarbosa:camiladias10@github.com/cdbarbosa/clone/blob/master/docs/orchestration/docker-swarm/docker-compose-secrets.yaml?raw=true) on your Swarm master. Then execute the command
